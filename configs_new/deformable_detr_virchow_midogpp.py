# configs/deformable_detr_virchow_midogpp.py
#
# Deformable DETR with a FROZEN Virchow (ViT-H/14) backbone +
...
#
# PATCH 14 -> same setup as H0 / H1 / UNI2-h DETR (1008 input -> 72x72 map).
...
# the H0 / H1 / UNI2-h DETR configs (kept constant for a fair backbone
# comparison); only the backbone and embed_dim (1280) change vs UNI2-h.
...
model = dict(
    ...
    # Virchow emits one (B, 1280, 72, 72) map. SimpleFeaturePyramid expands it
...
work_dir = './outputs/work_dirs/deformable_detr_virchow_1008_100epochs'
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='COMPAYL26',
            name='deformable_detr_virchow_midogpp',
            group='deformable_detr',
            tags=['Virchow', 'deformable_detr', 'midogpp', 'frozen', 'augmented'],
        ),
    ),
]
visualizer = dict(
