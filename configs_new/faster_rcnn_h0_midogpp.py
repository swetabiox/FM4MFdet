...
#
# Faster R-CNN with a FROZEN H-Optimus-0 (ViT-g/14) backbone +
...
resume = False
work_dir = './outputs/work_dirs/faster_rcnn_h0_1008_100epochs'
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='COMPAYL26',
            name='faster_rcnn_h0_midogpp',
            group='faster_rcnn',
            tags=['H-optimus-0', 'faster_rcnn', 'midogpp', 'frozen', 'augmented'],
        ),
    ),
]
visualizer = dict(
