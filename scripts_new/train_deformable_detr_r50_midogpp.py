# scripts/train_deformable_detr_r50_midogpp.py
"""Training script for Deformable DETR with a ResNet-50 backbone on MIDOG++.
...
CONFIG_NAME = "deformable_detr_r50_midogpp.py"
