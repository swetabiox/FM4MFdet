# scripts/train_deformable_detr_uni2h_midogpp.py
"""Training script for Deformable DETR with UNI2-h backbone on MIDOG++.
...
CONFIG_NAME = "deformable_detr_uni2h_midogpp.py"
