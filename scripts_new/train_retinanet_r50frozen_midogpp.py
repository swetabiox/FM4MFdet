# scripts/train_retinanet_r50frozen_midogpp.py
"""Training script for the FROZEN ResNet-50 retinanet_r50frozen baseline on MIDOG++.
...
CONFIG_NAME = "retinanet_r50frozen_midogpp.py"
