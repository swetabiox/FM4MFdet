# scripts/train_faster_rcnn_r50frozen_midogpp.py
"""Training script for the FROZEN ResNet-50 faster_rcnn_r50frozen baseline on MIDOG++.
...
CONFIG_NAME = "faster_rcnn_r50frozen_midogpp.py"
