# scripts/train_faster_rcnn_virchow2_midogpp.py
"""Training script for Faster R-CNN with Virchow2 backbone on MIDOG++.
...
CONFIG_NAME = "faster_rcnn_virchow2_midogpp.py"
