# scripts/train_deformable_detr_h1_midogpp.py

"""
Training script for Deformable DETR with H-Optimus-1 backbone on MIDOG++.
...
CONFIG_NAME = "deformable_detr_h1_midogpp.py"
