# scripts/train_deformable_detr_virchow2_midogpp.py
"""Training script for Deformable DETR with Virchow2 backbone on MIDOG++.
...
CONFIG_NAME = "deformable_detr_virchow2_midogpp.py"
