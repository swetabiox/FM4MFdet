# scripts/train_deformable_detr_virchow_midogpp.py
"""Training script for Deformable DETR with Virchow backbone on MIDOG++.
...
CONFIG_NAME = "deformable_detr_virchow_midogpp.py"
